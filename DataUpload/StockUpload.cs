...
namespace Project1.StockDataUpload
{
    internal class StockUpload
    {
        //this method read data from a CSV file and return it as a list of aCandleStick objects
        public static List<aCandleStick> GetCSVdata(string filename)
        {
            ...
            try
            {
                ...
                using (StreamReader r = new StreamReader(filename))
                {
                    ...
                    while (!r.EndOfStream)
                    {
                        ...
                        if (value.Length >= 9)
                        {
                            aCandleStick aCandleStick = new aCandleStick(value);
